...
external_stylesheets = ['https://github.com/abhishek22-tech/Data-Visualization-Assignments/blob/master/StyleSheet.css']
...
df = pd.read_csv('C:Users/abhis/Downloads/cereal.csv')
df2 = df
